...
class RecognitionAdapter(private val ctx: Context, private val callback : RecognitionCallback) :
    ...
    inner class RecognitionViewHolder(private val binding: RecognitionItemBinding) :
        ...
        fun bindTo(recognition: Recognition) {
            ...
            if (recognition.label == "Closed_Eyes" && recognition.confidence >= 0.7){
                callback.onRecognitionThreshold(recognition)
            }
        }
    }
