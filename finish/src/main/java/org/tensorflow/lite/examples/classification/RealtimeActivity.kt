...
import org.tensorflow.lite.examples.classification.ml.ModelEye
import org.tensorflow.lite.examples.classification.ui.RecognitionAdapter
import org.tensorflow.lite.examples.classification.ui.RecognitionCallback
 ...
 */
class RealtimeActivity : AppCompatActivity(), RecognitionCallback {
    ...
    private class ImageAnalyzer(ctx: Context, private val listener: RecognitionListener) :
        ...
        // method is called.
        private val modelEye: ModelEye by lazy{
            ...
            appContext = ctx
            ModelEye.newInstance(ctx, options)
        }
        ...
        override fun analyze(imageProxy: ImageProxy) {
            ...
            val outputs = modelEye.process(tfImage)
...
//            // END - Placeholder code at the start of the codelab. Comment this block of code out.
    ...
    override fun onRecognitionThreshold(recognition: Recognition) {
